...
mod unit_test {
    ...
    fn parse_nodeinfo_2_1() {
        ...
        let json_str_3 = r##"{"metadata":{"enableGlobalTimeline":true,"enableGuestTimeline":false,"enableLocalTimeline":true,"enableRecommendedTimeline":false,"maintainer":{"name":"Maria dev team"},"nodeDescription":"","nodeName":"Maria","repositoryUrl":"https://github.com/buka5587/maria.git","themeColor":"#F25A85"},"openRegistrations":false,"protocols":["activitypub"],"services":{"inbound":[],"outbound":["atom1.0","rss2.0"]},"software":{"homepage":"https://github.com/buka5587/maria.git","name":"Maria","repository":"https://github.com/buka5587/maria.git","version":"20240504"},"usage":{"localPosts":23857,"users":{"activeHalfyear":7,"activeMonth":7,"total":9}},"version":"2.1"}"##;
        ...
        assert_eq!(parsed_3, reparsed_3);
        assert_eq!(parsed_3.software.name, "Maria");
